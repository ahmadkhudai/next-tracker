                    ...
                    {currentWindow === MainWindows.home &&
                        ...
                        <div className={"flex align-items-center justify-content-between w-100"}>
                            ...
                            openPanel(OptionsPanels.QuotaPanel)
                                                                   ...
                                                                   styleClasses={" text-center w-auto text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-teal-600 font-bold text-xl ring ring-purple-900"}>{settings?.maxAcceptableRange.value}</OutlineRoundedButton>
