...
export default function AK_SettingsPanel(props:Props) {
    ...
    return (
        <div className={"container ak_max_600px text-center ak_card"} id={"settingsPanel"} style={visibilityStyle}>
                        ...
                        {setting.type === "checkbox" &&
                            <div className="d-inline-block flex items-center justify-content-center">
                                <div className="toggle colour">
                                    <input id="check3" className="toggle-checkbox hidden" type="checkbox" checked={setting.value}  onChange={(e) => handleSettingsChange(setting.label, !setting.value)}/>
            ...
            <button onClick={()=>{updateSettings(newSettings)}} className="btn btn-outline-dark w-full">Save</button>
        </div>
    );
}
